...
ggsave(filename = "131_figure_02_insertions_k1.pdf",
       height = 10,
       width = 10,
       useDingbats = FALSE)
...
write_delim(x = scores_matrix %>%
              ...
              pivot_longer(-c(insertion),
                           ...
                           values_to = "psi"),
            delim = "\t",
            file = "131_figure_01e_insertions.tsv")
...
pdf(file = "105_insertions_k1_dendrogram.pdf",
    height = 10,
    width = 10,
    useDingbats = FALSE)
...
ggsave(filename = "105_figure_02_insertions_k1_CLUSTERED.pdf",
       height = 12,
       width = 10,
       useDingbats = FALSE)
