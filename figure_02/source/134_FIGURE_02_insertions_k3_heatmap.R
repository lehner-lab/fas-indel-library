...
# my_colours <- viridis::viridis_pal(option = "magma")(11)
# my_colours <- rev(colorspace::divergingx_hcl(n = 11, palette = "Spectral"))[2:10]
# my_colours <- c(my_colours[1],
#                 my_colours,
#                 my_colours[length(my_colours)])

colour_function <- colorRampPalette(rev(colorspace::divergingx_hcl(n = 7, palette = "Spectral")[2:6]))
my_colours <- colour_function(11)
# my_colours <- rev(colorspace::divergingx_hcl(n = 11, palette = "ArmyRose"))
# my_colours <- rev(colorspace::divergingx_hcl(n = 11, palette = "Earth"))
# my_colours <- rev(colorspace::divergingx_hcl(n = 11, palette = "RdYlBu"))
...
ggsave(filename = "134_figure_02_insertions_k3.pdf",
       height = 12,
       width = 10,
       useDingbats = FALSE)
...
pdf(file = "134_insertions_k3_dendrogram.pdf",
    height = 10,
    width = 10,
    useDingbats = FALSE)
...
ggsave(filename = "134_figure_02_insertions_k3_CLUSTERED.pdf",
       height = 12,
       width = 10,
       useDingbats = FALSE)
